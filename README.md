...
| 名称 | 条件 | 占術的意味 |
| 妻動 (さいどう) | 人元 $\rightarrow$ 克 $\rightarrow$ 貴神 | 金運、女性、外部からの管理、目下とのトラブル。|
| 官動 (かんどう) | 貴神 $\rightarrow$ 克 $\rightarrow$ 将神 | 仕事、官職、公的トラブル、目上や権力との関わり。|
| 財動 (ざいどう) | 将神 $\rightarrow$ 克 $\rightarrow$ 地分 | 具体的な利益、商売、不動産、足元の利得。|
| 賊動 (ぞくどう) | 地分 $\rightarrow$ 克 $\rightarrow$ 将神 | 内部の裏切り、盗難、予期せぬ損失、詐欺。|
| 鬼動 (きどう) | 貴神 $\rightarrow$ 克 $\rightarrow$ 人元 | 精神的不安、怪異、予期せぬ大きな災難、目下からの反撃。|
...
| 相 (そう) | 月支が生み出す五行 (月支 $\rightarrow$ 生) | 1.5 | 強い。勢いがあり発展する。 |
| 休 (きゅう) | 月支を生む五行 (月支 $\leftarrow$ 生) | 1.0 | 普通。休息状態だが悪くはない。 |
| 囚（しゅう） | 月支を克す五行 (月支 $\leftarrow$ 克) | 0.5 | 弱い。力が抑制され、動きが鈍い。 |
| 死（し） | 月支に克される五行 (月支 $\rightarrow$ 克) | 0.0 | 無力。エネルギーが枯渇している。|
